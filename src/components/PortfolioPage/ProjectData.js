  ...
  react: [
    {
      ...
      stack: [
        ...
        { src: spotifyIcon, name: "SpotifyAPI" },
        { src: steamIcon, name: "SteamAPI" },
        { src: rawgIcon, name: "RawgAPI" },
      ],
    },
    {
      title: "JCJ Swag",
    ...
    },
    {
      title: "Phantom Chat",
      description:
        "A chat application built and inspired by the video game Persona 5. Allows users to upload their own photo, add friends, and chat as if they were a member of the Phantom Theives.",
      image: phantomChat,
